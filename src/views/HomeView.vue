      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div
          ...
          <p class="text-xl md:text-2xl text-gray-600 mb-8">
            מכירת חמץ מקוונת, פשוטה ומהירה לפני חג הפסח. <br> המתקיימת על ידי בית הכנסת בית אל הרצליה
          </p>
          ...
          <div class="mt-8">
            <ShareButtons title="שתפו חברים שעדיין לא עשו מכירת חמץ"
              text="מכירת חמץ מקוונת של בית הכנסת בית אל הרצליה - הזדרזו למלא את הטופס לפני פסח!" size="large" />
          </div>
        </div>
        ...
        <div
          ...
          <div class="mt-4">
            <ShareButtons title="שתפו עם חברים ומשפחה"
              text="האם מילאתם כבר את טופס מכירת החמץ? לחצו כאן לטופס מכירת חמץ מקוון של בית הכנסת בית אל הרצליה" />
          </div>
        </div>
          ...
          <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto" @click.stop>
            <div class="p-6">
              ...
              <div class="space-y-6">
                ...
                <!-- הוספת אפשרות שיתוף -->
                <div class="mt-6">
                  <ShareButtons title="שתפו מידע זה" text="מידע חשוב על מכירת חמץ לפסח - בית הכנסת בית אל הרצליה"
                    size="small" />
                </div>
              </div>
            </div>
